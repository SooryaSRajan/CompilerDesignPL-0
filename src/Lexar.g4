...
procDecl returns [ASTNode node] : PROCEDURE ID BRACKET_OPEN t21 = procFormalCallChoice BRACKET_CLOSE t22 = colonTypeChoice SEMICOLON t23 = block ID {$node = new BlockProcDecl($t21.node, $t22.node, $t23.node);};
